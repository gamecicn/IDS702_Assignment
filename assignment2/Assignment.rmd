...
final_model = lm(formula = bwt.oz ~ smoke + mht + mrace + mpregwt + parity_sqrt, data = df)
...
- The smoking behavior can significantly decrease birth weight by 9.4 oz on average. 95% CI is : `r c(confint(final_model)[2,1], confint(final_model)[2,2]) `
...
1. The final model's R-Square value is only 0.155.
